...
/**
 * Attention:
 * this is Email verification class only support Email for easy_net 163 or QQ
 * need to find code for gmail and hotmail.
 */
...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_ENT_QQ(false), "Your : Email address", " Your Password : Password");
    }
    ...
    public static void sendRegisterCode(String code, String address) throws Exception {
        EmailSender.subject("Your website or App name + register code ").from("Your website name")
                .text("Your code is " + code + "Code is available within 10 Mins").to(address).send();
